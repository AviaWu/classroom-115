...
test('boss battle shows its image and HP, advances automatically, and hides a defeated boss',async t=>{
    ...
    await h.run("answerBossQuestion(1,'dragon','q2',1,'')");assert.equal(h.cloud.students[0].bossProgress[0].hp,2);assert.match(h.w.document.querySelector('.boss-battle-message').textContent,/回復 1 點血量/);
